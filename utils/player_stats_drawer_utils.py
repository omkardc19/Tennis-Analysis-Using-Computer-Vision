...
def draw_player_stats(output_video_frames,player_stats):
    def draw_player_stats(output_video_frames, player_stats):
        """
        Draws player statistics on each frame of the output video.
        Parameters:
        output_video_frames (list of np.ndarray): List of video frames where statistics will be drawn.
        player_stats (pd.DataFrame): DataFrame containing player statistics with columns:
            - 'player_1_last_shot_speed': Last shot speed of player 1.
            - 'player_2_last_shot_speed': Last shot speed of player 2.
            - 'player_1_last_player_speed': Last player speed of player 1.
            - 'player_2_last_player_speed': Last player speed of player 2.
            - 'player_1_average_shot_speed': Average shot speed of player 1.
            - 'player_2_average_shot_speed': Average shot speed of player 2.
            - 'player_1_average_player_speed': Average player speed of player 1.
            - 'player_2_average_player_speed': Average player speed of player 2.
        Returns:
        list of np.ndarray: List of video frames with player statistics drawn on them.
        """
